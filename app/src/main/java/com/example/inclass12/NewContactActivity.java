                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                Log.d("demo", "new contact k andar ka " + document.getId() + " => " + document.getData());
                            }
                        } else {
...
Log.d("demo", "main if k andar");
                    ...
                    Log.d("demo", "add data me jaa raha!");
                            ...
                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                ...
                                public void onSuccess(final DocumentReference documentReference) {
                                    ...
                                    if (iv_camera.getDrawable() instanceof BitmapDrawable) {
                                        ...
                                        Log.d("demo", "if camera se NAHI kheecha to ~andar~ lol bahar XD");
